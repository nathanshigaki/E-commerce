...
public interface InventarioClient {
    ...
    @PutExchange("/api/inventario/decrement")
    ...
    @PatchExchange("/api/inventario/skucode/{skucode}")
    void updateStock(@PathVariable String skucode, @RequestParam Integer quantidade);
